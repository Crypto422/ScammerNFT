        ...
        <div className="container py-5">
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="0">
                    <Accordion.Header><i class="fab fa-quora"></i>How to Mint a Scammer?</Accordion.Header>
                    <Accordion.Body>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="1">
                    <Accordion.Header><i class="fab fa-quora"></i>What is the Total Supply?</Accordion.Header>
                    <Accordion.Body>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="2">
                    <Accordion.Header><i class="fab fa-quora"></i>	Which are the rarest NFTs & do they also have benefits?</Accordion.Header>
                    <Accordion.Body>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="3">
                    <Accordion.Header><i class="fab fa-quora"></i>What could you possibly win in a raffle?</Accordion.Header>
                    <Accordion.Body>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="4">
                    <Accordion.Header><i class="fab fa-quora"></i>Where can I view my NFTs after minting?</Accordion.Header>
                    <Accordion.Body>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="5">
                    <Accordion.Header><i class="fab fa-quora"></i>What are the minting costs for a Kick Scammers NFT?</Accordion.Header>
                    <Accordion.Body>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="6">
                    <Accordion.Header><i class="fab fa-quora"></i>Are Kick Scammers NFT a good investment?</Accordion.Header>
                    <Accordion.Body>
            ...
            <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce="true">
                <Accordion.Item eventKey="7">
                    <Accordion.Header><i class="fab fa-quora"></i>What is a Scam Database?</Accordion.Header>
                    <Accordion.Body>
                    Please have a look at <a href="scamlistcrypto.com" target="_blank">Scamlistcrypto.com</a> for more information.
                    </Accordion.Body>
                </Accordion.Item>
            </AnimationOnScroll>
